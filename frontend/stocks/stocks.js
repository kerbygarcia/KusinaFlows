...
itemForm.addEventListener("submit", async (e) => {
    ...
    const payload = {
        ...
        // Use "itemUTD" which matches your HTML date input ID exactly
        utdDateString: document.getElementById("itemUTD").value, 
...
async function syncInventoryFromServer() {
    try {
        ...
        console.log("Neon Postgres data synced successfully (All records included).");
    } catch (error) {
